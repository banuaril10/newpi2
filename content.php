      ...
      <div class="modal-body" style="background: #cacaca">
		...
		<div class="row-info"> 
			...
			<select name="sl" id="sl" class="selectize">
				...
				$sqll = "select value as storecode from ad_morg";
				...
				$sql2 = "select m_locator_id ,locator_name from pos_mproduct WHERE locator_name ilike '%GR AREA BOS%' and locator_name like '%".$storecode."%' group by m_locator_id ,locator_name";
