			 ...
			 <table>
				...
				<button class="btn btn-danger" type="button" id="btn-cetak-tinta-promo"><div class="item1"><b>CETAK HARGA PROMO</b></div></button>
					...
					<table class="table table-bordered" id="example">
						...
						foreach ($arrs as $row) { 
						$name = "";
						$q_cek_name = "select name from pos_mproduct where sku = '".$row['sku']."' ";
						...
						<?php if($q_stock > 0){ ?>
							<tr>
								<td><input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $row['sku']; ?>|<?php echo $name; ?>|<?php echo $row['price1']; ?>|<?php echo $row['price2']; ?>|<?php echo $row['price3']; ?>|<?php echo date('Y-m-d'); ?>|<?php echo $row['rack']; ?>|<?php echo $row['todate']; ?>|"></td>
