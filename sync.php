	...
	<div class="col-12">
      ...
      <div class="container-fluid">  
          ...
          <div class="row">
            ...
            <div class="row">
                <div class="col-md-2">     
                    <button type="button" id="btnproductcategorysync" class="btn btn-success btn-lg btn-block"><i class="fa fa-list"></i> Kategori <br>
                  Total : <?php echo $total_kategori; ?></button>
                </div>
                <div class="col-md-2">   
                    <button type="button" id="btnsyncitems" class="btn btn-success btn-lg btn-block"><i class="fa fa-cubes"></i> Product<br>
                  Total : <?php echo $total_product; ?></button>   
                </div>
                <div class="col-md-2">   
                    <button type="button" id="btnproductstocksync" class="btn btn-success btn-lg btn-block"><i class="fa fa-cubes"></i> Stock<br>
                  Total : <?php echo $total_stock; ?></button>                 
                </div>
                <div class="col-md-2">   
                    <button type="button" id="btnproductpricesync" class="btn btn-success btn-lg btn-block"><i class="fa fa-money"></i> Price<br>
                  Total : <?php echo $total_price; ?></button>                  
               </div>
                <div class="col-md-2">   
                    <button type="button" id="btnproductbarcode" class="btn btn-success btn-lg btn-block"><i class="fa fa-barcode"></i> Barcode<br>
                  Total : <?php echo $total_barcode; ?></button>                  
               </div>
                <div class="col-md-2">   
                    <button type="button" id="btnproductshortcut" class="btn btn-success btn-lg btn-block"><i class="fa fa-barcode"></i> Shortcut<br>
			...
			<div class="row">
                <div class="col-md-2">     
                    <button type="button" id="btnpromoreguler" class="btn btn-success btn-lg btn-block"><i class="fa fa-tags"></i> Promo Reguler<br>
                  Total : <?php echo $total_reguler; ?></button>
                </div>
                <div class="col-md-2">   
                    <button type="button" id="btnpromobuyget" class="btn btn-success btn-lg btn-block"><i class="fa fa-tags"></i> Promo Buy & Get<br>
                  Total : <?php echo $total_buyget; ?></button>   
                </div>
                <div class="col-md-2">   
                    <button type="button" id="btnpromogrosir" class="btn btn-success btn-lg btn-block"><i class="fa fa-tags"></i> Promo Grosir<br>
                  Total : <?php echo $total_grosir; ?></button>                 
                </div>
                <div class="col-md-2">   
                    <button type="button" id="btnpromocode" class="btn btn-success btn-lg btn-block"><i class="fa fa-tags"></i> Promo Code<br>
                  Total : <?php echo $total_code; ?></button>                  
                </div>
                 <div class="col-md-2">     
                    <button type="button" id="btnbanksync" class="btn btn-success btn-lg btn-block"><i class="fa fa-money"></i> Bank<br>
                  Total : <?php echo $total_bank; ?></button>
                </div>
                <div class="col-md-2">     
                    <button type="button" id="btnedcsync" class="btn btn-success btn-lg btn-block"><i class="fa fa-money"></i> EDC<br>
			...
			<div class="row">
                 ...
                 <div class="col-md-2">     
                    <button type="button" id="btnprofilesync" class="btn btn-success btn-lg btn-block"><i class="fa fa-user"></i> Profile<br>
                  Total : <?php echo $total_profile; ?></button>
                </div>
                 <div class="col-md-2">     
                    <button type="button" id="btnusersync" class="btn btn-success btn-lg btn-block"><i class="fa fa-user"></i> User<br>
                  Total : <?php echo $total_user; ?></button>
                </div>
                <div class="col-md-2">     
                    <button type="button" id="btnuserhrissync" class="btn btn-success btn-lg btn-block"><i class="fa fa-user"></i> User HRIS<br>
                  Total : <?php echo $total_user_hris; ?></button>
                </div>
                <div class="col-md-2">     
                    <button type="button" id="btnracksync" class="btn btn-success btn-lg btn-block"><i class="fa fa-user"></i> Rack<br>
