...
foreach ($j_hasil as $key => $value) {
    ...
    $max_kode_undian = $j_hasil[0]['max_kode_undian'];
    $phone = $j_hasil[0]['phone'];
    $tgl_dcni = $j_hasil[0]['tgl_dcni'];
    if ($isqty == 0) {
        ...
        note2='" . $note2 . "', note3='" . $note3 . "', website='" . $website . "', max_kode_undian='" . $max_kode_undian . "', 
        phone='" . $phone . "',avatar='" . $tgl_dcni . "'";
    } else {
        $update = "UPDATE ad_morg
        SET name='" . $name . "', value='" . $value . "', address1='" . $address1 . "', 
        ...
        max_kode_undian='" . $max_kode_undian . "', phone='" . $phone . "',avatar='" . $tgl_dcni . "'";
    }
}
